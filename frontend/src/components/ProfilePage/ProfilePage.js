      ...
      <main className="main bg-dark">
          ...
          <div className="header header-open">
            ...
            {errorState ? (
              <div className="error-message1">
                Name or Surname can't be empty!
              </div>
            ) : null}
            <div className="header-open-content">
              <div className="input-group">
                <input
                  id="firstname"
                  placeholder={isAuth.user.firstName}
                  onChange={onFirstNameChange}
                />
                <input
                  id="lastname"
                  placeholder={isAuth.user.lastName}
              ...
              <div className="button-group">
                ...
                <button className="cancel-button" onClick={handleEditClose}>
                  Cancel
                </button>
              </div>
            </div>
        ...
        <section className="account">
          ...
          <div className="account-content-wrapper cta">
            <button
              ...
              onClick={(e) => handleNavigateDetail(e, 1)}
            >
              View transactions
            </button>
          </div>
        ...
        <section className="account">
          ...
          <div className="account-content-wrapper cta">
            <button
              className="transaction-button"
              onClick={(e) => handleNavigateDetail(e, 2)}
            >
              View transactions
            </button>
          </div>
        ...
        <section className="account">
          ...
          <div className="account-content-wrapper cta">
            <button
              className="transaction-button"
              onClick={(e) => handleNavigateDetail(e, 3)}
            >
              View transactions
            </button>
          </div>
